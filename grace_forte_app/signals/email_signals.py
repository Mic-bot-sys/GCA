...
def emailNotifySignals(sender, instance, created, **kwargs):
    if created:
        ...
        result = ConfirmedTemplateEmailNotify(instance.user.email, "Confirmed Transaction", "The Transaction you made has been confirmed by us. You can therefore proceed to the next line of action", instance.user.user_profile.firstName)
